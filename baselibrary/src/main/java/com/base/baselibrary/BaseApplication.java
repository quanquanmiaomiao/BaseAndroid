...
import com.base.baselibrary.utils.okgo.RequestTokenInterceptor;
...
public class BaseApplication extends Application {
    ...
    private void initOkGo() {
        ...
        builder.addInterceptor(new RequestTokenInterceptor());//利用拦截器添加token
